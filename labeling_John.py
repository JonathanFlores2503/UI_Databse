...
#         self.root = root
#         self.root.title("Anotador PhD - Jonathan Flores - Control Triple de Etiquetas")
...
#         # Quitar foco de los BBox al hacer clic en el fondo
...
#     def bind_keys(self):
#         # Validar si el foco está en un cuadro de texto para no disparar acciones por error
...
#         except: messagebox.showerror("Error", "N Previos inválido")
...
#         except: messagebox.showerror("Error", "N Posteriores inválido")
...
#     def delete_tag(self):
#         if self.anomalies: self.anomalies.pop()
...
#         with open("Temporal_annotation.txt", "a") as f: f.write(line + "\n")
#         messagebox.showinfo("Éxito", "Datos fusionados y guardados")
#         self.anomalies = []
